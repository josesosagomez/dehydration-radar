...
```bash
rsync -av --progress data/77ghz/  <user>@ilogin.ibex.kaust.edu.sa:/ibex/user/<user>/dehyd/data/77ghz/   # ~22 GB
rsync -av --progress data/10ghz/  <user>@ilogin.ibex.kaust.edu.sa:/ibex/user/<user>/dehyd/data/10ghz/
rsync -av --progress data/weight/ <user>@ilogin.ibex.kaust.edu.sa:/ibex/user/<user>/dehyd/data/weight/
```
...
```bash
rsync -av <user>@ilogin.ibex.kaust.edu.sa:/ibex/user/<user>/dehyd/results/ results/
